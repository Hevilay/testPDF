...
public class ChartSupport {
	...
	public static Color[] CHART_COLORS = {
			new Color(255,216, 162), new Color(255,216,113), new Color(255,183,82), new Color(111,179,244),
			new Color(68,183,211), new Color(100,149, 237), new Color(135,184,127), new Color(164,151,200),
			new Color(218,112,214),new Color(209,91,71) };// 颜色
	...
	public static void setXAixs(CategoryPlot plot) {
		...
		plot.getDomainAxis().setMaximumCategoryLabelLines(10);//X坐标轴文字行数设置
		plot.getDomainAxis().setCategoryLabelPositions(CategoryLabelPositions.UP_45);//倾斜显示
	}
	...
	public static void setPieRender(Plot plot) {
		...
		piePlot.setBaseSectionOutlinePaint(new Color(255, 255, 221));
		//指定 section 轮廓线的厚度
	 ...
	 * @throws IOException
	 */
	public static void genPngPic(File file, JFreeChart chart, int width, int height) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static byte[] genPngBytes(JFreeChart chart, int width, int height) throws IOException {
